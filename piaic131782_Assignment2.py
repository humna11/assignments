...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = print(np.dstack((x,y))) #write your code here 
...
def function17():
    ...
    return    np.where(np.logical_and(arr%3==0,arr%5==0), "YES", "NO")  #wrtie your code here       # Write Your Code HERE
...
def function18():
    ...
    x = np.count_nonzero (np.intersect1d(students,piaic)) # Write you code Here
    return x
